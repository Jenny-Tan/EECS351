...
% b (array of double): transfer function coefficients (numerator)
% a (array of double): transfer function coefficients (denominator)
% Fs: sampling frequency
% G (double): gain
% fc (int): cutoff frequency
% type (char): can be 'b' for bass or 't' for treble

% convert the gain into voltage difference and calculate K
K = tan((pi * fc) / Fs);
V = 10 ^ (G / 20);
